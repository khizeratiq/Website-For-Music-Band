<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nauman.aspx.cs" Inherits="SE.BandMembers" %>
...
<div class="w3-main w3-content" style="max-width:1600px;margin-top:83px">
  ...
  <div class="w3-row w3-grayscale-min">
    <div>
        <h1 style="text-align:center;"> Nauman Saleem </h1>
        <h3 style="text-align:center;">Rhythm Guitarist</h3>
        <h4 style="text-align:center;">Nauman plays guitars.He is a rhythm guitarist of the band.<br/> He does pluckings as well.He supports the vocalist as a back-vocaist too.</h4>
      <img src="nomi11.jpg" style="width:60% ;height:50% ; margin-left:auto ; margin-right:auto; display: block;" onclick="onClick(this)" alt="Guitarist">
      <img src="nomi2.jpeg" style="width:60% ;height:50% ; margin-left:auto ; margin-right:auto; display: block;" onclick="onClick(this)" alt="Rhythmist">
