<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ahad.aspx.cs" Inherits="SE.Ahad" %>
...
<div class="w3-main w3-content" style="max-width:1600px;margin-top:83px">
  ...
  <div class="w3-row w3-grayscale-min">
    ...
    <div>
         <h1 style="text-align:center;"> Ahad Jawed Chaudary </h1>
        <h3 style="text-align:center;">Main Vocalist</h3>
        <h4 style="text-align:center;">Ahad is a singer.He is the main vocalist of the band.</h4>
      <img src="Ahad1.jpg" style="width:60% ;height:50% ; margin-left:auto ; margin-right:auto; display: block;"  onclick="onClick(this)" alt="Vocalist">
      <img src="ahad2.jpg" style="width:60% ;height:50% ; margin-left:auto ; margin-right:auto; display: block;"  onclick="onClick(this)" alt="Main Vocalist">
